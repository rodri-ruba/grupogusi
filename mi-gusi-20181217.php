            ...
            <div class="row">
                <div class="col-md-8 col-sm-6 wow animate fadeInLeft">
                    <div class="c-content-overlay">
                        ...
                        <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 550px; background-image: url('static/img/recetas/gucamole-con-carne-seca.jpg');"></div>
                    </div>
                </div>
                    ...
                    <div class="c-wrapper c-bg-red" style="height: 550px;">
                        <div class="c-content c-border c-border-padding c-border-padding-right">
                            <h3 class="c-title c-font-25 c-font-white
                                c-font-uppercase c-font-bold">Este mes la receta favorita es: <?php echo strtoupper($rec1["rec_nombre"]); ?></h3>
                            <p class="c-description c-font-17
                            c-font-white">Prepárala siguiendo los pasos dando click en ver más.</p>
                            <p class="c-price c-font-55 c-font-white
                            c-font-thin">¡Deliciosa!</p>
                        ...
                        <div class="c-overlay-wrapper">
                            <div class="c-overlay-content">
                               ...
                               Las mejores recetas y tips para preparar <br> tus cortes en la parrilla.</p>
                                <a href="parrilla/index.html" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-2x c-btn-square">Ver más</a>
                            </div>
                        </div>
