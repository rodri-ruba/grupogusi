...
{
	$sql  = " SELECT * ";
	$sql .= " FROM recetario_14febrero "; 
	$sql .= " WHERE recetario_14febrero.rec_email = '$rec_email' "; 
	$sql .= " AND recetario_14febrero.rec_momento <= '$timestamp_compara' ";
	...
	{
		$sql  = " INSERT INTO `recetario_14febrero` ( ";
		$sql .= " `rec_momento` , ";
		$sql .= " `rec_session_id` , ";
		$sql .= " `rec_nombre` , ";
		$sql .= " `rec_email` , ";
...
<div>
	...
	<a href="/pdf-recetario/recetario_grupo_gusi_14febrero.pdf" target="_blank" class="btn btn-lg c-btn-white c-font-uppercase c-btn-square c-btn-border-1x" style="position: relative !important; bottom: 0; margin-top: 15px;">Descargar</a>
</div>
