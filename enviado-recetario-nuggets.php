...
{
	$sql  = " SELECT * ";
	$sql .= " FROM recetario_nuggets "; 
	$sql .= " WHERE recetario_nuggets.rec_email = '$rec_email' "; 
	$sql .= " AND recetario_nuggets.rec_momento <= '$timestamp_compara' ";
	...
	{
		$sql  = " INSERT INTO `recetario_nuggets` ( ";
		$sql .= " `rec_momento` , ";
		$sql .= " `rec_session_id` , ";
		$sql .= " `rec_nombre` , ";
		$sql .= " `rec_email` , ";
		...
		$mail_subject = "Grupo Gusi: Descarga de recetario nuggets"; 
...
<div>
	<p class="c-price c-font-white c-font-thin">
		...
		<br><br>
		Por favor haz click en el siguiente botón para descargar el recetario nuggets:
	</p>
	
	<a href="/pdf-recetario/recetario-nuggets.pdf" target="_blank" class="btn btn-lg c-btn-white c-font-uppercase c-btn-square c-btn-border-1x" style="position: relative !important; bottom: 0; margin-top: 15px;">Descargar</a>
</div>
