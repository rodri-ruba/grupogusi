...
<html lang="es_MX">
    ...
    <head>
        <!--<base href="/static/">-->
        <meta charset="utf-8" />
        <title>Grupo Gusi | Bolsa de trabajo</title>
                    ...
                    <div class="tp-banner rev_slider" data-version="5.0">
                        <ul>    <!-- SLIDE  -->
                            <li data-index="rs-38" 
                                ...
                                <!-- IMAGEN PRINCIPAL -->
                                <img src="../../static/img/grupo_gusi/nuestra-gente.jpg"  alt=""  
                ...
                <div class="container">
                    <div class="c-content-counter-1 c-opt-1">
                        <div class="c-content-title-1">
                            <h3 class="c-center c-font-uppercase c-font-bold c-font-red-1">ENVIANOS TUS DATOS Y NOS PONDREMOS EN CONTACTO CONTIGO <br> TENEMOS UN LUGAR PARA TI</h3>
                        </div>
                        <div class="col-md-12">
                            <form action="../trabajos_form/index.html" class="form-horizontal" method="post">
                              <h2>Datos de contacto</h2>
                              <hr>

                              <div class="form-group">
                                <label for="denominacion" class="col-sm-3 control-label">Nombre y apellido:</label>
                              ...
                              <div class="form-group">
                                <label for="rfc" class="col-sm-3 control-label">Correo:</label>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group col-sm-3">
                                  ...
                                  <!-- <input type="text" class="form-control" id="estado" 
                                    name="estado" placeholder="DISTRITO FEDERAL"> -->
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="estado" class="col-sm-3 control-label">Áreas de interés:</label>
                                <div class="input-group col-sm-3">
                                  <select name="areas" id="areas" class="selectpicker form-control" data-live-search="true">
                              ...
                              <div class="form-group">
                                <label for="denominacion" class="col-sm-3 control-label">Describe brevemente tu experiencia profesional</label>
                                <div class="input-group col-sm-9">
                                    <textarea rows="4" cols="50" name="comentarios" required>
                                    </textarea>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <div class="input-group col-md-2 col-md-offset-3">
                                    <button type="submit" class="btn c-btn-border-2x c-btn-uppercase btn-lg c-btn-bold c-btn-square">Enviar</button>
                                </div>
                              </div>            
                            </form>
                        </div>
