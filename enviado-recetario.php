...
if($rec_nombre && $rec_email)
{
	$sql  = " SELECT * ";
	$sql .= " FROM recetario "; 
	$sql .= " WHERE recetario.rec_email = '$rec_email' "; 
	$sql .= " AND recetario.rec_momento <= '$timestamp_compara' ";
	...
	else
	{
		...
		$mail_subject = "Grupo Gusi: Descarga de recetario"; 
...
<div>
	<p class="c-price c-font-white c-font-thin">
		...
		<br><br>
		Por favor haz click en el siguiente botón para descargar el recetario:
	</p>
	
	<a href="/pdf-recetario/recetario_grupo_gusi.pdf" target="_blank" class="btn btn-lg c-btn-white c-font-uppercase c-btn-square c-btn-border-1x" style="position: relative !important; bottom: 0; margin-top: 15px;">Descargar</a>
</div>
