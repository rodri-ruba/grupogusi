...
{
	$sql  = " SELECT * ";
	$sql .= " FROM recetario_patrio "; 
	$sql .= " WHERE recetario_patrio.rec_email = '$rec_email' "; 
	$sql .= " AND recetario_patrio.rec_momento <= '$timestamp_compara' ";
	...
	{
		$sql  = " INSERT INTO `recetario_patrio` ( ";
		$sql .= " `rec_momento` , ";
		$sql .= " `rec_session_id` , ";
		$sql .= " `rec_nombre` , ";
		$sql .= " `rec_email` , ";
		...
		$mail_subject = "Grupo Gusi: Descarga de recetario patrio"; 
...
<div>
	<p class="c-price c-font-white c-font-thin">
		...
		<br><br>
		Por favor haz click en el siguiente botón para descargar el recetario patrio:
	</p>
	
	<a href="/pdf-recetario/recetario_grupo_gusi_patrio.pdf" target="_blank" class="btn btn-lg c-btn-white c-font-uppercase c-btn-square c-btn-border-1x" style="position: relative !important; bottom: 0; margin-top: 15px;">Descargar</a>
</div>
