...
<html lang="es_MX">
    ...
    <head>
        <!--<base href="/static/">-->
        <meta charset="utf-8" />
        <title>Grupo Gusi | Grupo Gusi</title>
        ...
        <meta property='og:title' content="La mejor carne de México."/>
        <meta property='og:description' content="Producir, procesar y comercializar productos cárnicos de bovino y derivados, con calidad y precios competitivos para tiendas de autoservicios y consumidores finales de acuerdo a las normas nacionales e internacionales, cumpliendo la entrega en tiempo y forma."/>
        <meta property='og:image' content="http://grupogusi.com.mx/static/img/logo-centro.png">
        <meta property='og:url' content="http://grupogusi.com.mx">
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar c-layout-header-topbar-collapse">
                        ...
                        <nav class="c-mega-menu c-pull-left c-mega-menu-light c-mega-menu-light-mobile c-fonts-uppercase c-fonts-bold" style="background-color: rgba(255,255,255,0.9)">
                            <ul class="nav navbar-nav c-theme-nav">
                                ...
                                <li class="c-active c-menu-type-classic">
                                    <a href="mi_gusi.html" class="c-link dropdown-toggle">Mi Gusi
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                    
                                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                        <li class="dropdown-submenu">
                                            <a href="recetas/index.html">Recetas
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="cocina/index.html">Cocina
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="parrilla/index.html">Parrilla
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="c-active c-menu-type-classic">
                                    <a href="noticias/index.html" class="c-link dropdown-toggle">Noticias
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="recetas/index.html" class="c-link dropdown-toggle">Recetas
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="javascript:;" class="c-link dropdown-toggle" onclick="javascript:location.href='/pagina/productos'">Productos
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="javascript:;" class="c-link dropdown-toggle" onclick="javascript:location.href='/pagina/grupo_gusi'">Grupo Gusi
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                        <li class="dropdown-submenu">
                                            <a href="grupo_gusi/index.html#mision">Misión y visión
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="grupo_gusi/index.html#valores">Valores
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="nuestra_gente/index.html">Nuestra Gente
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="responsabilidad_social/index.html">Responsabilidad social
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="certificaciones/index.html">Certificaciones
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="procesos/index.html">Procesos
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="exportacion/index.html">Exportaciones
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="trabajos/index.html">Trabajos
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                    </ul>
        ...
        <div class="c-layout-page">
                    ...
                    <div class="tp-banner rev_slider" data-version="5.0">
                        <ul>    <!-- SLIDE  -->
                            <li 
                                ...
                                data-thumb="/static/img/slides/grupo_gusi/header-grupo-gusi.jpg"  
                                data-delay="4330"  
                                data-rotate="0"  
                                data-saveperformance="off"  
                                data-title="Unlock Power">
                                <!-- MAIN IMAGE -->
                                <img src="../static/img/slides/grupo_gusi/header-grupo-gusi.jpg"  
            ...
            <div class="c-content-box c-size-lg c-bg-parallax" style="background-image: url('../static/img/grupo_gusi/fondo.jpg')" id="mision">                
                <div class="container">
                    <div class="c-content-title-1 wow animate fadeInDown">
                        <h3 class="c-font-uppercase c-center c-font-bold">Nosotros</h3>
                    </div>                    
                    <div class="">
                        <div class="row">
                            <div class="col-md-7">
                               <iframe width="100%" height="415" src="https://www.youtube.com/embed/GYqzp6z_wJY" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="col-md-5">
                                    ...
                                    <div class="panel-group" id="accordion" role="tablist">
                                        <div class="panel">
                                            <div class="panel-heading" role="tab" id="headingOne">
                                                <h4 class="panel-title">
                                                    <a class="c-font-bold c-font-uppercase c-font-19" data-toggle="collapse" data-parent="#accordion" href="../static/index.html#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Misión </a>
                                                </h4>
                                            </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading" role="tab" id="headingTwo">
                                                <h4 class="panel-title">
                                                    <a class="collapsed c-font-uppercase c-font-bold c-font-19" data-toggle="collapse" data-parent="#accordion" href="../static/index.html#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Visión </a>
                                                </h4>
                                            </div>
                                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                <div class="panel-body
                                                    c-font-18">Posicionarnos en
                                                    los primeros lugares
                                                    nacionales e internacionales
                                                    en ventas de productos
                                                    cárnicos con calidad total. </div>
                                            </div>
                                        </div>
                                        <!--
                                        <div class="panel">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                <div class="panel-body c-font-18">
                                                    <ul>
                                                        <li><strong>Cumplir:</strong> Con
                                                        los requisitos legales
                                                        aplicables de los
                                                        clientes y partes
                                                        interesadas.</li>
                                                        <li><strong>Satisfacer:</strong> Las
                                                        necesidades de nuestros
                                                        clientes suministrando
                                                        productos inocuos y de
                                                        calidad.</li>
                                                        <li><strong>Mejorar:</strong> Continuamente
                                                        nuestros procesos a
                                                        todos los niveles de la
                                                        organización.</li>
                                                        <li><strong>Mantener:</strong> Una
                                                        comunicación eficaz
                                                        entre nuestros
            ...
            <!-- VALORES-->
            <div class="c-content-box c-size-md c-bg-white" id="valores">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="c-content-title-1 c-margin-b-60">
                                <h3 class="c-center c-font-uppercase c-font-bold"> Valores </h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-sm-6 wow animate fadeInLeft">
                            <div class="c-content-step-1 c-opt-1 c-center">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/honestidad.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">1. Honestidad</div>
                                <div class="c-description c-font-17"> Ser transparentes e íntegros en todas nuestras acciones.</div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 wow animate fadeInLeft" data-wow-delay="0.2s">
                            <div class="c-content-step-1 c-opt-1">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/respeto.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">2. Respeto</div>
                                <div class="c-description c-font-17"> Mantener un ambiente de respeto mutuo con nuestros compañeros de trabajo, clientes y proveedores, que contribuya a construir relaciones sanas y productivas. </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 wow animate fadeInLeft" data-wow-delay="0.4s">
                            <div class="c-content-step-1 c-opt-1">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/compromiso.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">3. Compromiso Con Nuestro México</div>
                                <div class="c-description c-font-17"> Con nuestro trabajo contribuimos a la prosperidad de la comunidad regional y de la sociedad mexicana.</div>
                            </div>
                        </div>
                    </div>
                    <!--Segunda linea de valores-->
                    <div class="row">
                        <div class="col-md-4 col-sm-6 wow animate fadeInLeft">
                            <div class="c-content-step-1 c-opt-1 c-center">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/disciplina.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">4. Disciplina</div>
                                <div class="c-description c-font-17"> Ser constantes en el cumplimiento de nuestro trabajo realizándolo de manera ordenada hasta el logro de los objetivos.</div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 wow animate fadeInLeft" data-wow-delay="0.2s">
                            <div class="c-content-step-1 c-opt-1">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/responsabilidad.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">5. Responsabilidad</div>
                                <div class="c-description c-font-17"> A través de nuestro trabajo diario, reafirmamos el compromiso que tenemos en nosotros mismos y con Grupo GUSI, con su crecimiento y desarrollo.</div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 wow animate fadeInLeft" data-wow-delay="0.4s">
                            <div class="c-content-step-1 c-opt-1">
                                <div class="c-icon">
                                    <img class="img-responsive" src="../static/img/grupo_gusi/trabajo.jpg" alt="Grupo gusi" style="margin-left:40%">
                                </div>
                                <div class="c-title c-font-20 c-font-bold c-font-uppercase">6. Trabajo En Equipo</div>
                                <div class="c-description c-font-17"> El Trabajo en Equipo fortalece nuestra calidad humana y sentido de pertenencia permitiéndonos ser más productivos en el logro de nuestros objetivos y metas.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="c-content-counter-1 wow animate fadeInDown">
                        <div class="c-content-title-2 c-center">
                            ...
                            <h3 class="c-center c-font-uppercase c-font-white c-font-bold"><a href="nuestra_gente/index.html" class="c-font-white">NUESTRA GENTE</h3></a>
                            <a href="nuestra_gente/index.html"><h5 class="c-font-uppercase btn btn-md c-btn-red">Ver más</h5></a>
                        </div>
                    </div>
                </div>
            </div>

            <!--DIVISION EN DOS RESPONSABILIDAD SOCIAL Y TECNOLOGIA-->
                        ...
                        <div class="col-md-6 col-sm-6 wow animate fadeInLeft">
                            <div class="c-content-overlay">
                                <div class="c-overlay-wrapper">
                                    <div class="c-overlay-content">
                                        <a href="responsabilidad_social.html" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-2x c-btn-square">Ver más</a>
                                    </div>
                                </div>
                                <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 550px; background-image: url('../static/img/grupo_gusi/resp-social.jpg');"></div>
                            </div>
                        </div>
                         <div class="col-md-6 col-sm-6 wow animate fadeInRight">
                            <div class="c-content-overlay">
                                <div class="c-overlay-wrapper">
                                    <div class="c-overlay-content">
                                        <a href="certificaciones/index.html" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-2x c-btn-square">Ver más</a>
                                    </div>
                                </div>
                                <div class="c-bg-img-center c-overlay-object" data-height="height" style="height: 550px; background-image: url('../static/img/grupo_gusi/certificaciones.jpg');"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="c-content-box c-size-md">
                <div class="container">
                    ...
                    <div id="container">
                        ...
                        <a href="procesos/index.html"><img src="../static/img/grupo_gusi/procesos.jpg" style="width:100%; height:100%"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 c-center wow animate fadeInUp">
                        <a href="exportacion.html"> <img src="../static/img/grupo_gusi/exportacion.jpg" style="width:100%; height:100%"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 c-center wow animate fadeInRight">
                        <a href="trabajos.html"><img src="../static/img/grupo_gusi/bolsa-trabajo.jpg" style="width:100%; height:100%"></a>
                        </div>                                    
                    </div>                
                </div>
            </div>                
        ...
        <footer class="c-layout-footer c-layout-footer-4 c-bg-footer-8">
                    ...
                    <div class="row">
                        <div class="col-md-6 c-footer-4-p-right">
                            <div class="c-content-title-1 c-center">
                                <h3 class="c-font-uppercase c-font-thin
                                    c-font-black c-border">Grupo Gusi
                                    <span class="c-theme-font"> </span>
                                </h3>
                            </div>
                            <p class="c-contact c-font-black">
                                <span>
                                     <a class="c-font-white" href="mailto:contacto@grupogusi.com">contacto@grupogusi.com</a>
                                </span>
                           </p>
                            <ul class="c-socials">
                                <li>
                                    <a href="https://www.facebook.com/GrupoGusi/" target="_blank">
                                        <i class="icon-social-facebook"></i>
                                    </a>
                                </li>
                                <li>
                            ...
                            <p class="c-contact">
                                <span>
                                     <a class="c-font-white" href="../static/files/avisodeprivacidad.pdf" target="_blank">Aviso de privacidad</a>
                                </span>
                                <ul class="c-content-list-1">
                                    <li>
                                        <a class="c-font-white" href="inicio/index.html">HOME</a>
                                    </li>
                                    <li>
                                        <a class="c-font-white" href="mi_gusi/index.html">MI GUSI</a>
                                    </li>
                                    <li>
                                        <a class="c-font-white" href="noticias/index.html">NOTICIAS</a>
                                    </li>
                                    <li>
                                        <a class="c-font-white" href="recetas/index.html">RECETAS</a>
                                    </li>
                                    <li>
                                        <a class="c-font-white" href="http://www.grupogusi.com.mx/pagina/productos/">PRODUCTOS</a>
                                    </li>
                                    <li>
                                        <a class="c-font-white" href="grupo_gusi/index.html">GRUPO GUSI</a>
                                    </li>
                        ...
                        <div class="col-md-6 c-footer-4-p-left">
                            <div class="c-feedback">
                                <h3 class="c-font-bold c-font-red">Contáctanos</h3>
                                <form action="contact_form.html" method="POST">
                                    ...
                                    <textarea rows="8" name='mensaje' placeholder="Escribe tu mensaje aqui" class="form-control"></textarea>
                                    <button type="submit" class="btn c-btn-red c-btn-border-2x c-btn-uppercase btn-lg c-btn-bold c-btn-square">Enviar</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    <p class="c-font-white">Copyright  Grupo Gusi 2016. Todos los derechos reservados.</p>
                 </div>
            </div>
        </footer>
	...
	<![endif]-->
        ...
        <script src="../static/assets/base/js/scripts/pages/extended-portfolio.js" type="text/javascript"></script>
        <!-- END: THEME SCRIPTS -->
        <!-- BEGIN: PAGE SCRIPTS -->
        <script>
            $(document).ready(function()
