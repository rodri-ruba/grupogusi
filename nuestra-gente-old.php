...
<html lang="es_MX">
    ...
    <head>
        <!--<base href="/static/">-->
        <meta charset="utf-8" />
        <title>Grupo Gusi | Nuestra gente</title>
    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar c-layout-header-topbar-collapse">
                            ...
                            <ul class="nav navbar-nav c-theme-nav">
                                ...
                                <li class="c-active c-menu-type-classic">
                                    ...
                                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                        ...
                                        <li class="dropdown-submenu">
                                            <a href="index.html">Nuestra Gente
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
        ...
        <div class="c-layout-page">
                    ...
                    <div class="tp-banner rev_slider" data-version="5.0">
                        <ul>    <!-- SLIDE  -->
                            <li data-index="rs-38" 
                                ...
                                <!-- IMAGEN PRINCIPAL -->
                                <img src="../../static/img/slides/nuestra_gente/nuestra-gente.jpg"  alt=""  
                ...
                <div class="container">
                    <div class="c-content-counter-1 c-opt-1">
                        <div class="c-content-title-1">
                            <h3 class="c-center c-font-uppercase c-font-bold">NUESTROS NÚMEROS</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="c-counter c-theme-border c-font-bold c-theme-font" data-counter="counterup">1,960</div>
                                <h4 class="c-title c-first c-font-uppercase c-font-bold">EMPLEOS DIRECTOS</h4>
                                
                            </div>
                            <div class="col-md-4">
                                <div class="c-counter c-theme-border c-font-bold c-theme-font" data-counter="counterup">8,000</div>
                                <h4 class="c-title c-font-uppercase c-font-bold">EMPLEOS INDIRECTOS</h4>
                                
                            </div>
                            <div class="col-md-4">
                                <div class="c-counter c-theme-border c-font-bold c-theme-font" data-counter="counterup">+10,000</div>
                                <h4 class="c-title c-font-uppercase c-font-bold">FAMILIAS BENEFICIADAS</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!--INICIO NUESTRA GENTE-->   
            <div class="c-content-box c-size-md c-bg-grey-1">
                <div class="container">
                    <div class="c-content-title-1">
                        <h3 class="c-center c-font-uppercase c-font-bold">NUESTRA GENTE</h3>
                    </div>
                    <div class="cbp-panel">
            ...
            <!--INICIO BLOQUE FONDO VERDE-->
            <div class="c-content-box c-size-md c-bg-parallax" style="background-image: url('../../static/img/nuestra_gente/bg-cita.jpg')">
                <div class="container">
                    <div class="c-content-counter-1 wow animate fadeInDown">
                        <div class="c-content-title-2">
                            <h3 class="c-center c-font-uppercase c-font-white c-font-bold">
            ...
            <!--FIN DE LA PAGINA-->
            <div class="c-content-box c-size-lg c-bg-parallax" style="background-image: url('../../static/img/grupo_gusi/fondo.jpg')">                
                <div class="container">
                    <div class="c-content-title-1 wow animate fadeInDown">
                        <h3 class="c-font-uppercase c-center c-font-bold">ACERCA DE NOSOTROS</h3>
                    </div>                    
                    <div class="">
                        <div class="row">
                            <div class="col-md-7">
                            ...
                            <div class="col-md-5">
                               <img src="../../static/img/nuestra_gente/imagen-inferior.jpg" class="img-responsive">
                            </div>
                        </div>
                    </div>
                </div>
