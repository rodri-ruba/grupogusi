                        ...
                        <nav class="c-mega-menu c-pull-left c-mega-menu-light c-mega-menu-light-mobile c-fonts-uppercase c-fonts-bold" style="background-color: rgba(255,255,255,0.9)">
                            <ul class="nav navbar-nav c-theme-nav">
                                ...
                                <li class="c-active c-menu-type-classic">
                                    <a href="mi-gusi.php" class="c-link dropdown-toggle">Mi Gusi
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                    
                                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                        <li class="dropdown-submenu">
                                            <a href="recetas.php">Recetas
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="cocina.php">Cocina
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="parrilla.php">Parrilla
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="c-active c-menu-type-classic">
                                    <a href="noticias.php" class="c-link dropdown-toggle">Noticias
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="recetas.php" class="c-link dropdown-toggle">Recetas
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="productos.php" class="c-link dropdown-toggle">Productos
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li class="c-active c-menu-type-classic">
                                    <a href="grupo-gusi.php" class="c-link dropdown-toggle">Grupo Gusi
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                    <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                        <li class="dropdown-submenu">
                                            <a href="grupo-gusi.php#mision">Misión y visión
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="grupo-gusi.php#valores">Valores
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="nuestra-gente.php">Nuestra Gente
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="responsabilidad-social.php">Responsabilidad social
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="certificaciones.php">Certificaciones
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                            <a href="procesos.php">Procesos
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                        </li>
                                        <li class="dropdown-submenu">
                                ...
                                <li class="c-active c-menu-type-classic">
                                    <a href="cedis.php" class="c-link dropdown-toggle">CEDIS
                                        <span class="c-arrow c-toggler"></span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://www.grupogusi.com.mx/en.html" style="padding-top:18px;">
                                        <img src="/static/img/en/united-states.png" width="25px">
                                    </a>
                            </ul>
                        </nav>
                        <!-- END: MEGA MENU -->
